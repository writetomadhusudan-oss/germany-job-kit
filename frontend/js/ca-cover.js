/* Canada cover letter generator — North-American business letter. Client-side only. */
...
function render() {
  ...
  const h =
    ...
    '<p>' + sal + '</p>' +
    p.map(x => '<p>' + x + '</p>').join('') +
    '<div class="close"><p>Sincerely,</p><br><p>' + esc(name) + '</p></div>';
...
$('fillSample').addEventListener('click', () => {
  const s = {
    c_name: 'Priya Sharma', c_city: 'Toronto, ON', c_phone: '+1 416 555 0132',
    c_email: 'priya.sharma@example.com', c_linkedin: 'linkedin.com/in/priyasharma',
    c_contact: 'Ms. Lee', c_company: 'Example Corp', c_ccity: 'Toronto, ON',
    c_role: 'SAP SuccessFactors Consultant', c_source: 'LinkedIn on September 20, 2026',
    c_open: 'Your team\u2019s focus on cloud HR transformation for mid-size manufacturers matches exactly what I have done for the past eight years, and I am excited by the chance to bring that experience to the Canadian market.',
    ...
    c_auth: 'Authorized to work in Canada',
    c_date: 'September 25, 2026'
  };
